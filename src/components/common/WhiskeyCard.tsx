...
import { WhiskeyPlaceholder } from './WhiskeyPlaceholder';
import { useUserData } from '../../hooks/useUserData';
import type { WhiskeyEntry } from '../../types';

interface WhiskeyCardProps {
  entry: WhiskeyEntry;
}

export function WhiskeyCard({ entry }: WhiskeyCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <WhiskeyPlaceholder subcategory={entry.subcategory} size="small" />
        </div>
