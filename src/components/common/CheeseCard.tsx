...
import { CheesePlaceholder } from './CheesePlaceholder';
import { useUserData } from '../../hooks/useUserData';
import type { CheeseEntry } from '../../types';

interface CheeseCardProps {
  entry: CheeseEntry;
}

export function CheeseCard({ entry }: CheeseCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CheesePlaceholder subcategory={entry.subcategory} size="small" />
        </div>
