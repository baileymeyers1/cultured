...
export function CoffeeCard({ entry }: CoffeeCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CoffeePlaceholder subcategory={entry.subcategory} size="small" />
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {entry.specifications.roastLevel} Roast &middot; {entry.origin}
          </p>
